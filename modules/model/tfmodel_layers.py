...
class MFilmConvBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel):
        ...
        # self.mlp = nn.Linear(in_features=out_channel, out_features=out_channel)
...
class GBlock(nn.Module):
    def __init__(self, in_channel, out_channel, factor, block_num, film_type, event_dim, mamba_interleave=False):
        super().__init__()
        self.factor = factor
