...
class FilmConvBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel, factor=1, bidirectional:bool=False):
        super().__init__()
        ...
        self.conv1 = nn.Conv1d(in_channels=in_channel*(bidirectional+1), out_channels=out_channel, kernel_size=3, padding=1)
...
class BFilmConvBlock(nn.Module):
    ...
    def __init__(self, in_channel, out_channel):
        super().__init__()
        # self. proj not really projeting anything! todo: mamba
        self.proj = Conv1d(in_channel, out_channel, 3, padding=1)
        self.act = nn.SiLU()
        self.conv = Conv1d(out_channel, out_channel, 3, padding=1)
...
class GBlock(nn.Module):
    def __init__(self, in_channel, out_channel, factor, block_num):
        super().__init__()
        self.factor = factor
